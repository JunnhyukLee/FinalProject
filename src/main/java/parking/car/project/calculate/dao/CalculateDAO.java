...
public interface CalculateDAO {
    ...
    @Select("SELECT calculate_code, calculate_amount from calculate "
    		+ "where calculate_code = #{calculate_code}")
    public List<CalculateDTO> calculatePay(int calculate_code);
}
