...
<script>
    function cancelEdit() {
        window.location.href = "${pageContext.request.contextPath}/NoticeSelectDetail?notice_code=${noticeDTO.notice_code}";
    }
</script>
</head>
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/NoticeUpdate" method="post" id="notice_form">
                                <sec:csrfInput />
                                <fieldset>
