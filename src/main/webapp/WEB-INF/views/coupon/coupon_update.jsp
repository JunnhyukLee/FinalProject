					...
					<div class="card">
						...
						<form action="./CouponUpdate" method="post"
							...
							<fieldset>
								...
								<div class="form-group row">
									<label for="coupon_name" class="ml-sm-3 col-form-label"> 쿠폰 이름 </label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									...
									<div class="ml-sm-3">
										<input type="text" name="coupon_price" id="coupon_price"
											class="form-control form-control-sm"
											value="${couponDTO.coupon_price}"></div></div>
											<label
											for="coupon_price" class="ml-sm-3 col-form-label"> 사용 여부 </label> <div class="ml-sm-3"><input type="radio"
											name="coupon_use" id="coupon_use_available" value="사용가능"
											${couponDTO.coupon_use == '사용가능' ? 'checked' : ''}>
										사용가능 <input type="radio" name="coupon_use"
											id="coupon_use_used" value="사용불가능"
											${couponDTO.coupon_use == '사용불가능' ? 'checked' : ''}>
										이미사용된쿠폰 </div>
										
										<div class="form-group row">
                                        <label for="parking_code" class="ml-sm-3 col-form-label"> 주차장 코드 </label>
                                        <div class="ml-sm-3">
                                            <input type="text" name="parking_code" id="parking_code" class="form-control form-control-sm" value="${couponDTO.parking_code}">
                                        </div>
                                    </div>
						...
						<a href="./CouponSelect" class="btn btn-danger btn-block"> 쿠폰 목록 </a> <a
							href="./CouponDelete?coupon_code=${param.coupon_code}" class="btn btn-danger btn-block">
							쿠폰 목록 삭제 </a>
					</div>
				</div>
			</div>
